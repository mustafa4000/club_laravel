                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full" src="{{ url($item->photo) }}" alt="{{ 'photo of'.$item->name ?? '' }}">  
                                                {{-- alt -> jika ada kegagalan dalam load gambar maka string alt akan nampil manggil nama  --}}
                                            </div>
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">
                                                    {{ $item->old. ' Years' ?? '' }}
                                                    {{-- years => kalimat tahun concet cenery operator  --}}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td class="px-6 py-4 whitespace-newrap">Data Not Found</td>
                                </tr>
                                @endforelse
